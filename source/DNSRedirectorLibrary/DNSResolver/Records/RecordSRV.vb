    ...
    Public Class RecordSRV
        ...
        Public Overrides ReadOnly Property Data() As Byte()
            Get
                ...
                bytes.AddRange(BitHelpers.WriteShort(PRIORITY))
                bytes.AddRange(BitHelpers.WriteShort(WEIGHT))
                bytes.AddRange(BitHelpers.WriteShort(PORT))
                bytes.AddRange(BitHelpers.WriteName(TARGET))
