...
Namespace Dns
    Public Class RecordISDN
        Inherits Record
        Public ISDNADDRESS As String
        Public SA As String

        Public Overrides ReadOnly Property Data() As Byte()
            Get
                Dim StringBytes() As Byte = System.Text.Encoding.ASCII.GetBytes(ISDNADDRESS)
                ...
                StringBytes = System.Text.Encoding.ASCII.GetBytes(SA)
                'bytes.AddRange(BitHelpers.WriteShort(StringBytes.Length))
                bytes.Add(Convert.ToByte(StringBytes.Length))
                bytes.AddRange(StringBytes)
