...
&nbsp; X <font face="Verdana" style="font-size: 8.5pt">Windows 10, 8.1, 8, 7 SP1 - strongly discouraged due <a target="_blank" href="http://jpelectron.com/sample/WWW and HTML/IIS- OS Version Limits.htm">IIS limitations</a>, 
but acceptable when pointing to <a href="http://jpelectron.com/sample/DNSRedir/networks/03.htm">another IIS server running on server OS</a>.</font><br>
...
&nbsp; 4 GB of RAM<br>
&nbsp; 10 MB of available hard disk space (also 2.5 GB for <a href="full-faq.htm#108">.NET Framework 4.6.1</a>)<br>
<br>
...
&nbsp; Installation on <a href="full-faq.htm#91">existing domain controller</a> is acceptable.<br>
...
<br>
Any device with a TCP/IP connection is <a href="full-faq.htm#98">considered a client</a> and can resolve DNS records through the DNS Redirector server.<br>
...
&nbsp;&nbsp;&nbsp;&nbsp; 1) Download the software from <a href="https://github.com/JPElectron/DNSRedirOSS/raw/master/dnsredir-download.zip">https://github.com/JPElectron/DNSRedirOSS/raw/master/dnsredir-download.zip</a><br>
<font face="Verdana" style="font-size: 5pt">&nbsp;<br>
</font>
...
See the <a href="http://jpelectron.com/sample/DNSRedir/networks">Network Examples</a>. Notice that <a href="full-faq.htm#32">proxy</a>/SOCKS, ISA, or <a href="full-faq.htm#33">ICS</a> is not compatible.<br>
<br>
...
<a href="http://jpelectron.com/sample/DNSRedir/networks/06.htm">06</a>, 
<a href="http://jpelectron.com/sample/DNSRedir/networks/09.htm">09</a>, 
<a href="http://jpelectron.com/sample/DNSRedir/networks/10.htm">10</a>.<br>
You should mitigate problems as discussed in 
<a href="full-faq.htm#34">FAQ 34</a>, 
<a href="full-faq.htm#39">FAQ 39</a>, 
<a href="full-faq.htm#113">FAQ 113</a>, 
<a href="full-faq.htm#126">FAQ 126</a>.<br>
<br>
...
If Microsoft's DNS service (found on some Windows Servers or Active Directory domain controllers) is installed see <a href="full-faq.htm#91">FAQ 91</a>.<br>
If another DNS server or something using the same ports is installed see <a href="full-faq.htm#4">FAQ 4</a>.<br>
<br>
...
If running multiple instances of DNS Redirector (only for content filtering, see <a href="full-faq.htm#28">FAQ 28</a>) then add the IP of every DNS Redirector server.<br>
<br>
No NAT and no DNS separation...<br>
The DNS Redirector server and all clients cannot be separated by a NAT device, see <a href="full-faq.htm#37">FAQ 37</a>, <a href="full-faq.htm#142">FAQ 142</a>.<br>
...
<br>
For third-party software that is known to work with or aid in the use of DNS Redirector see <a href="full-faq.htm#71">FAQ 71</a>.<br>

<br>
<br>
<b><a name="sec3">Installation</a></b><br>
<br>
<input type="checkbox" name="stepA" value="Done"> Download the software from <a href="https://github.com/JPElectron/DNSRedirOSS/raw/master/dnsredir-download.zip">https://github.com/JPElectron/DNSRedirOSS/raw/master/dnsredir-download.zip</a><br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp; If you are upgrading see <a href="full-faq.htm#103">FAQ 103</a>.<br>
<br><font face="Verdana" style="font-size: 5pt">
<br></font>
<input type="checkbox" name="stepB" value="Done"> Configure C:\DNSREDIR\dnsredir.ini (see <a href="#sec4">INI Settings</a> section below)<br><font face="Verdana" style="font-size: 5pt">
<br></font>
<input type="checkbox" name="stepC" value="Done"> Setup IIS or other web server software (see <a href="#sec5">Hosted Pages</a> section below)<br><font face="Verdana" style="font-size: 5pt">
<br></font>
<input type="checkbox" name="stepD" value="Done"> Verify firewall exceptions have been defined, see <a href="full-faq.htm#102">FAQ 102</a>.<br><font face="Verdana" style="font-size: 5pt">
<br></font>
<input type="checkbox" name="stepE" value="Done"> Verify the working directory has adequate permissions, see <a href="full-faq.htm#129">FAQ 129</a>.<br><font face="Verdana" style="font-size: 5pt">
<br></font>
<input type="checkbox" name="stepF" value="Done"> For Captive Portal, whitelist domains you may need, see <a href="full-faq.htm#121">FAQ 121</a>, <a href="full-faq.htm#159">FAQ 159</a>.<br><font face="Verdana" style="font-size: 5pt">
<br></font>
<input type="checkbox" name="stepG" value="Done"> For Internet filtering, whitelist domains you may need, see <a href="full-faq.htm#112">FAQ 112</a>.<br><font face="Verdana" style="font-size: 5pt">
<br></font>
<input type="checkbox" name="stepG" value="Done"> For Internet filtering, blacklist any domains you don't need, see <a href="full-faq.htm#52">FAQ 52</a>, <a href="full-faq.htm#106">FAQ 106</a>.<br><font face="Verdana" style="font-size: 5pt">
<br></font>
...
&nbsp; Specify the static IP address(es) of this DNS Redirector server (recommended), see <a href="full-faq.htm#4">FAQ 4</a>, <a href="full-faq.htm#91">FAQ 91</a>.<br>
...
Use the same steps as if you were setting up a RedirectIP= site at this IP, see the <a href="#sec5">Hosted Pages</a> section.&nbsp; <br>
<br>
...
&nbsp; Initially redirect clients to this IP, where your <a href="http://jpelectron.com/sample/DNSRedir/pages/">welcome page</a> is hosted.<br>
...
See the <a href="#sec5">Hosted Pages</a> section for setting up a page at this IP address.&nbsp; 
This must be an IP address, not a URL, for information on redirecting to an existing website or 
URL see <a href="full-faq.htm#30">FAQ 30</a>.&nbsp; <br>
...
See <a href="full-faq.htm#159">FAQ 159</a>.&nbsp; 
...
completely separate from the internal/office network as shown in <a href="http://jpelectron.com/sample/DNSRedir/networks/06.htm">Network Examples</a>.&nbsp; <br>
		<br></font></td>
	</tr>
</table>
...
&nbsp; Domain names matched in the BlockedKeywordsFile= below will resolve to this IP, where your <a href="http://jpelectron.com/sample/DNSRedir/pages/">blocked page</a> is hosted.<br>
...
See the <a href="#sec5">Hosted Pages</a> section for setting up a page at this IP address.&nbsp; <br>
<br></font><table border="0" id="BlockedIP" cellspacing="0" cellpadding="0">
	<tr>
		...
		To automate the updating of keywords see <a href="full-faq.htm#52">FAQ 52</a>.&nbsp; 
To block everything see <a href="full-faq.htm#5">FAQ 5</a>.&nbsp; 
...
See <a href="full-faq.htm#112">FAQ 112</a>.&nbsp; 
...
&nbsp;</font><table border="0" id="ActionNumber" cellspacing="0" cellpadding="0">
	<tr>
		...
		The client's IP is passed as a variable after the command for use with a third-party script or application, see <a href="full-faq.htm#62">FAQ 62</a>.&nbsp; 
...
IIS on a non-server OS has <a target="_blank" href="http://jpelectron.com/sample/WWW and HTML/IIS- OS Version Limits.htm">restrictions</a>, 
such configuration is not supported or recommended.&nbsp; 
Using <a target="_blank" href="http://jpelectron.com/sample/JPElectron/SimpleHTTP-Readme.asp">SimpleHTTP</a> 
...
(see screenshot for <a href="http://jpelectron.com/sample/DNSRedir/IIS7-ASPinstall.gif">IIS7</a> 
or <a href="http://jpelectron.com/sample/DNSRedir/IIS8-ASPinstall.gif">IIS8</a>)<br>
<br>
...
&nbsp;<img border="0" src="/images/arrowdn.gif" align="absbottom">&nbsp; in IIS Manager create a site:&nbsp; 
...
&nbsp;<img border="0" src="/images/spacer.gif" align="absbottom">&nbsp; for IIS6: leave checked "Allow anonymous access to this Web site" | leave checked "Read" | check "Run scripts (such as ASP)"<br>
<input type="checkbox" name="step02" value="Done"> extract a <a href="http://jpelectron.com/sample/DNSRedir/pages/">sample welcome page</a> to the folder created above<br>
<br>
...
<input type="checkbox" name="step09" value="Done"> extract a <a href="http://jpelectron.com/sample/DNSRedir/pages/">sample blocked page</a> to the folder created above<br>
<input type="checkbox" name="step15" value="Done"> download: <a href="http://jpelectron.com/sample/DNSRedir/REG-UrlSegmentMaxLength.zip">REG-UrlSegmentMaxLength.zip</a> then open the .reg file<br>
&nbsp;&nbsp;&nbsp;&nbsp; <font face="Verdana" style="font-size: 8.5pt">this is necessary so certain blocked content is replaced correctly, see <a href="full-faq.htm#169">FAQ 169</a></font><br>
<br>
...
(see screenshot for <a href="http://jpelectron.com/sample/DNSRedir/IIS6-HttpHeadersTab.gif">IIS6</a>
or <a href="http://jpelectron.com/sample/DNSRedir/IIS7-HttpHeadersTab.gif">IIS7</a>)<br>
&nbsp;&nbsp;&nbsp;&nbsp; <font face="Verdana" style="font-size: 8.5pt">META tags which preventing caching (as included in the <a href="http://jpelectron.com/sample/DNSRedir/pages/">example pages</a>) are required in addition to this HTTP Header 
...
(see <a href="http://jpelectron.com/sample/DNSRedir/IIS6-ASPdotNETver.gif">screenshot</a>)<br>
<br>
<input type="checkbox" name="step25" value="Done"> on IIS7 under Error Pages, Edit Feature Settings, set "Custom error pages"&nbsp; 
(see <a href="http://jpelectron.com/sample/DNSRedir/IIS7-ErrorPagesSettings.gif">screenshot</a>)<br>
<br>
<input type="checkbox" name="step26" value="Done"> Enable Parent Paths&nbsp; 
(see screenshot for <a href="http://jpelectron.com/sample/DNSRedir/IIS6-ASPEnableParentPaths.gif">IIS6</a>
or <a href="http://jpelectron.com/sample/DNSRedir/IIS7-ASPEnableParentPaths.gif">IIS7</a>)<br>
<br>
<input type="checkbox" name="step27" value="Done"> check NTFS permissions on the root folder&nbsp; 
(see screenshot for <a href="http://jpelectron.com/sample/DNSRedir/IIS6-DirSecurity.gif">IIS6</a> 
or <a href="http://jpelectron.com/sample/DNSRedir/IIS7-DirSecurity.gif">IIS7</a>)<br>
