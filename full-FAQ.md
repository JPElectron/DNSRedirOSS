...
<a name="2"><hr style="border: 1px; height: 1px; background: #AAAAAA;"><h3>FAQ 2: Licensing DNS Redirector v7</h3><font size=1>Category: Initial setup</font></a><br>
<hr style="border: 1px; height: 1px; background: #AAAAAA;"><br>
There are no renewal/maintenance/subscription fees for the software to keep working.<br>
<br>
Support can only assist with installation/configuration.<br>
<br><hr style="border: 1px; height: 1px; background: #AAAAAA;"><br>
...
<br>
&nbsp;[ See a sample allowed file here: <a href="http://jpelectron.com/sample/DNSRedir/example-allowed.txt">example-allowed.txt</a> ]<br>
...
as explained in <a href="full-faq.htm#110">FAQ 110</a>.<br>
<br>
...
or <a target="_blank" href="http://www.dd-wrt.com">DD-WRT</a> and disable <a href="full-faq.htm#110">DNS Masquerading</a>.<br>
...
allowing only UDP 53 (for DNS) and TCP 80 (for IIS) inbound to the server, see <a href="full-faq.htm#142">FAQ 142</a> and <a href="full-faq.htm#37">FAQ 37</a>.<br>
<br>
...
Greatly improve network security by blocking <a href="full-faq.htm#106">ccTLD's and GeoTLD's</a> that are not relevant to your business. 
...
<br>
Download: <a href="http://jpelectron.com/sample/DNSRedir/JoinAction-leddigit.zip">JoinAction-leddigit.zip</a> v2.0.0.0 r06/09/2010<br>
...
<hr style="border: 1px; height: 1px; background: #AAAAAA;"><br>
Download: <a href="http://jpelectron.com/sample/DNSRedir/JoinAction-variables.zip">JoinAction-variables.zip</a> and extract to the C:\DNSREDIR working directory.<br>
<br>
...
3) Download: <a href="http://jpelectron.com/sample/DNSRedir/JoinAction-ledsign.zip">JoinAction-ledsign.zip</a> 
...
<br>
If using <a href="full-faq.htm#52">updater.exe</a> check the option "Include keywords aiding lack of NXDomain" to suppress the OpenDNS guide/block/adult/phish page. 
Any such site will result in your blocked page instead.<br>
<br>
Additionally, you could add the domains below to your blocked.txt file, or if using <a href="full-faq.htm#52">updater.exe</a> to your blocked-custom.txt file.<br>
<br>
...
<br>
This works assuming OpenDNS is configured upstream as the real DNS server, as described in <a href="full-faq.htm#40">FAQ 40</a>.<br>
<br>
Note: After 9 years OpenDNS <a target="_blank" href="http://blog.opendns.com/2014/05/29/no-more-ads/">has finaly conceded</a> that ads and security don't mix, 
as a result there is no guide page and you will get NXDOMAIN and SERVFAIL responses, therefore some information in this article is no longer applicable.<br>
<br><hr style="border: 1px; height: 1px; background: #AAAAAA;"><br><b>Related articles</b><br>
...
This service can co-exist on the same server running DNS Redirector, see <a href="full-faq.htm#91">FAQ 91</a>. 
...
Use a benchmark tool <a href="http://jpelectron.com/sample/DNSRedir/DNSTest">as described here</a> to determine the fastest DNS servers from your connection.<br>
<br>
...
<br>
Method 1) Use this sample alert notice, Download: <a href="http://jpelectron.com/sample/DNSRedir/alertnotice.zip">alertnotice.zip</a><br>
...
DNS Redirector software offers some unique features the others don't...<br>
 ...
 - fully customize/brand your welcome or blocked pages (100% your HTML, <a href="http://jpelectron.com/sample/DNSRedir/pages">samples provided</a>)<br>
 - block everything and allow just a few sites (<a href="full-faq.htm#5">whitelist only</a>)<br>
...
- <a target="_blank" href="http://jpelectron.com/sample/JPElectron/SimpleHTTP-Readme.asp">SimpleHTTP</a><br>
<br>
...
- <a target="_blank" href="https://firebog.net">The Big Blocklist Collection</a> see <a href="full-faq.htm#72">FAQ 72</a><br>
- <a target="_blank" href="https://blocklist.site">Block List Project</a> see <a href="full-faq.htm#72">FAQ 72</a><br>
- <a target="_blank" href="https://github.com/StevenBlack/hosts">Unified hosts file</a> see <a href="full-faq.htm#72">FAQ 72</a><br>
<br>
Review/statistics across multiple log files...<br>
- <a target="_blank" href="http://www.microsoft.com/download/en/details.aspx?id=24659">Microsoft Log Parser</a> see <a href="full-faq.htm#111">FAQ 111</a><br>
- <a target="_blank" href="http://www.splunk.com">Splunk</a><br>
- See <a href="http://jpelectron.com/sample/DNSRedir/Reporting">sample files</a><br>
<br>
Condense or email alert from log files...<br>
- See <a href="http://jpelectron.com/sample/DNSRedir/nxlog-ce">sample files</a><br>
<br>
Monitor the DNS Redirector server...<br>
- <a target="_blank" href="http://www.paessler.com">PRTG</a> see <a href="full-faq.htm#157">FAQ 157</a><br>
<br>
...
<br>
You can add more domains to your blocked.txt file, or if using <a href="full-faq.htm#52">updater.exe</a> to your blocked-custom.txt file.<br>
<br>
...
...this is used as the list of allowed websites that 1st tier users may visit, add any <a href="full-faq.htm#79">domain name</a>s you want. 
See <a href="full-faq.htm#5">FAQ 5</a> for other domains that you'll need to add here.<br>
<br>
BlockedIP=192.168.0.2<br>
...this becomes the Blocked page for the 2nd tier users<br>
BlockedKeywordsFile=blocked.txt<br>
...this is used as the list of blocked sites (use our keywords lists, or add any <a href="full-faq.htm#79">domain name</a>s you want)<br>
...
<br>
* For a password login, use <a href="http://jpelectron.com/sample/DNSRedir/pages/blocked -suggested.zip">blocked -suggested.zip</a> for each site in IIS 
(creating seperate sites at IP .0.3 and .0.2) see <a href="full-faq.htm#76">FAQ 76</a>.<br>
For integrating with Active Directory credentials see <a href="full-faq.htm#100">FAQ 100</a>.<br>
For setting the tier at logon see <a href="full-faq.htm#77">FAQ 77</a>.<br>
...
<hr style="border: 1px; height: 1px; background: #AAAAAA;"><br>
The sample <a href="http://jpelectron.com/sample/DNSRedir/pages/blocked -suggested.zip">blocked -suggested.zip</a> automatically replaces blocked content with the correct type to avoid seeing broken images or flash objects.<br>
<br>
...
<br>
Change the <a href="full-faq.htm#79">domain name</a> pinged in the example below to match what you have specified in authorized.txt or bypassblock.txt<br>
<br>
 - - - - - START login.bat - - - - -<br>
@ECHO OFF<br>
...
see <a href="full-faq.htm#106">FAQ 106</a>.<br>
<br>
An even better way to ensure network security and prevent problems is to <a href="full-faq.htm#5">block everything</a> and whitelist 
...
In Windows 2003 and below, ensure only the original server IP appears in the list box (as <a href="http://jpelectron.com/sample/DNSRedir/DNS2003-InterfacesTab.gif">shown here</a>)<br>
In Windows 2008 and above, ensure only the original server IP appears checked (as <a href="http://jpelectron.com/sample/DNSRedir/DNS2008-InterfacesTab.gif">shown here</a>)<br>
<br>
...
<br>
Download: <a href="http://jpelectron.com/sample/DNSRedir/reporting/all-reporting.zip">all-reporting.zip</a> and extract to the C:\DNSREDIR\Reporting directory<br>
Then run _checkdns_.bat to display these statistics<br>
<br>
...
Allow C:\DNSREDIR\updater.exe (if using <a href="full-faq.htm#52">Updater</a>)<br>
<br>
...
2) Download the software from <a href="https://github.com/JPElectron/DNSRedirOSS/raw/master/dnsredir-download.zip">https://github.com/JPElectron/DNSRedirOSS/raw/master/dnsredir-download.zip</a><br>
...
Note: New and/or different INI settings have been added, see the <a href="full-readme.htm">readme</a>.<br>
1) Stop the DNS Redirector service<br>
...
4) Install <a href="full-faq.htm#108">.NET Framework</a> (and restart)<br>
5) Download the software from <a href="https://github.com/JPElectron/DNSRedirOSS/raw/master/dnsredir-download.zip">https://github.com/JPElectron/DNSRedirOSS/raw/master/dnsredir-download.zip</a><br>
...
&nbsp;&nbsp;&nbsp; ! Verify the working directory permissions, see <a href="full-faq.htm#129">FAQ 129</a>.<br>
...
<br>
&nbsp;<b>[</b> See a sample blocked file here: <a href="http://jpelectron.com/sample/DNSRedir/example-blocked-custom.txt">example-blocked-custom.txt</a> <b>]</b><br>
...
<br>
4) Wait for <a href="full-faq.htm#168">.NET optimization</a> to finish<br>
<br>
...
<hr style="border: 1px; height: 1px; background: #AAAAAA;"><br>
Some D-Link, Linksys, Netgear, and other <a href="full-faq.htm#35">consumer or home-grade devices</a> have an option called DNS Relay or DNS Proxy and this option must be disabled 
...
<br>
For an easy menu that facilitates running these commands, download: <a href="http://jpelectron.com/sample/DNSRedir/reporting/all-reporting.zip">all-reporting.zip</a> and extract to the C:\DNSREDIR\Reporting directory<br>
<br>
...
Therefore, you should block all domains ending with these ccTLD's (and any/all other countries your organization doesn't conduct business in) per <a href="full-faq.htm#106">FAQ 106</a>. 
...
<br>
Most effective for network security is to check the 1st list, and implement a ccTLD block per <a href="full-faq.htm#106">FAQ 106</a><br>
...
<br>
Download: <a href="http://jpelectron.com/sample/DNSRedir/allowmore.zip">allowmore.zip</a><br>
<br>
...
Code sample: <a href="http://jpelectron.com/sample/DNSRedir/wwwmobile.zip">wwwmobile.zip</a><br>
...
&nbsp;&nbsp;&nbsp;.To = strTo<br>
<br>
Update "yoursmtpserver.example.com" with the IP or hostname of your SMTP server which is allowed to <a target="_blank" href="http://jpelectron.com/sample/WWW and HTML/IIS- SMTP service to send via gmail.htm">relay email</a>.<br>
<br>
On a 64-bit server running IIS, in the Advanced Settings of the application pool for your blocked site, set Enable 32-Bit Applications: True (as <a href="http://jpelectron.com/sample/DNSRedir/IIS7-Enable32BitAppOnWin64.gif">shown here</a>)<br>
<br>
For other issue see 
...
See <a target="_blank" href="http://jpelectron.com/sample/JPElectron/Switch over Ethernet">WebRelay usage examples</a>.<br>
<br>
1) Install <a href="full-faq.htm#108">.NET Framework 4.x</a><br>
<br>
2) Install <a href="http://jpelectron.com/download/SWMonDNSRSetup.msi">SWMonDNSR</a> Service<br>
<br>
...
ExampleB: Use BlockedKeywordsFile= with just a . in it to block everything, see <a href="full-faq.htm#5">FAQ 5</a><br>
<br>
...
<a href="http://jpelectron.com/sample/DNSRedir/networks">Network Examples</a>.<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; This also limits your ability to enforce DNS Redirector as the only DNS server, as described in <a href="full-faq.htm#34">FAQ 34</a>.<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; it does not have to be a separate server, see <a href="full-faq.htm#91">FAQ 91</a>.<br>
<br>
...
either by checking "Run updaterdone.bat when done" (if using <a href="full-faq.htm#52">Updater</a>) or by adding a scheduled task to run updaterdone.bat directly.<br>
<br>
...
<br>
&nbsp;&nbsp; 1) Download: <a href="http://jpelectron.com/sample/DNSRedir/SimpleHTTP-rejectHTTPS.zip">SimpleHTTP-rejectHTTPS.zip</a> and extract to C:\SIMPLEHTTP<br>
...
Some users may come onto your network with a DNS server set statically on their machine, which <a href="full-faq.htm#34">may render them unable to surf</a>.<br>
<br>
...
<br>
 ...
 - Type of device<br>
<br>
See <a href="http://jpelectron.com/sample/DNSRedir/DeviceSelfRegistration">sample screenshots</a><br>
<br>
...
<br>
Download: <a href="http://jpelectron.com/sample/DNSRedir/pages (custom)/welcome -devicereg.zip">welcome -devicereg.zip</a><br>
...
&nbsp;- close all Internet browsers and <a href="full-faq.htm#12">flush the DNS cache</a><br>
<br>
<br>
...
<br>
To continue blocking URL redirect services you could add these domains to your blocked.txt file, or if using <a href="full-faq.htm#52">updater.exe</a> to your blocked-custom.txt file.<br>
Example sources...<br>
...
&nbsp;&nbsp; ...you need to do this for <a target="_blank" href="https://www.google.com/supported_domains">every Google ccTLD</a> (such as .ca) that your users may visit. Optionally use DNS Redirector to <a href="full-faq.htm#106">block all other ccTLDs</a>.<br>
<br>
...
<br>
Note: Before this change takes effect you will need to close all Internet browsers and <a href="full-faq.htm#12">flush the DNS cache</a><br>
<br>
